# Astute Canary
Welcome to the Astute Canary - Syndromic Community Tracker. This provides the front-end framework for a COVID-19 Community Tracker Web application, focusing on tracking users symptoms, vaccination and testing history. 
