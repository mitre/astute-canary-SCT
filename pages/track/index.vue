    ...
    <div class="max-w-md mx-auto flex flex-col flex-grow h-full w-full pt-12">
      ...
      <div class="flex-grow my-auto bg-light-background p-4 rounded-t-4xl mt-16">
        <div class="flex flex-col self-center h-full items-center justify-center mt-12">
          ...
          <app-icon-button type="tertiary" size="large" icon="syringe" class="mt-8" @clicked="reportVaccination" text="Vaccination">Vaccination Experience</app-icon-button>
          <app-icon-button type="tertiary" size="large" icon="microscope" class="mt-8" @clicked="reportTesting" text="Testing">Testing & Diagnosis</app-icon-button>
        </div>
      </div>
    </div>
  </div>
